...
#INITIAL DATA IMPORT + FORMATTING ----------------------------------------------------------------------
        ...
        ## VOLUMES
                ...
                plot_volumes <- read.csv('1_Albedo_Exclosures/Approach_3/Output/Tree_Volumes/total_plot_volumes_approach_3.csv', header = TRUE)
                
                #Add plot volumes to existing site data (i.e. create 'main' dataset)
                main <- cbind(site_data, plot_volumes$Total_plot_volume)
        ...
        #Albedo function
                ...
                for(i in 1:length(site_data$LocalityCode)){
                        ...
                        #Get corresponding function arguments
                                ...
                                #Volume
                                a_vol <- plot_volumes$Total_plot_volume[plot_volumes$Site_name == b & plot_volumes$Treatment == c]
...
#EXPLORE DATA -----------------------------------------------------------------------------
        ...
        ##Coalesce all data into single dataframe (for analysis)
                ...
                for(i in 1:nrow(model_data)){
                        ...
                        #Get corresponding 'Clearcut to LiDAR' number & add
                ...
                model_data$Clearcut_Lidar <- as.numeric(model_data$Clearcut_Lidar)
...
#WRITE OUTPUT  ----------------------------------------------------------------------------
        ...
        write.csv(model_data, file = '1_Albedo_Exclosures/Approach_3/Output/Albedo_Estimates/albedo_estimates_approach_3.csv', row.names = TRUE)
        
        #Export albedo boxplot as PNG
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Albedo_Estimates/albedo_boxplot_approach_3.png",
            width = 2000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Albedo_Estimates/albedo_time_series_approach_3.png",
            width = 3000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Albedo_Estimates/albedo_grouped_boxplot_approach_3.png",
            width = 3000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Albedo_Estimates/albedo_histogram_approach_3.png",
            width = 2500,
            height = 2000,
            units = "px",
            bg = "white")
