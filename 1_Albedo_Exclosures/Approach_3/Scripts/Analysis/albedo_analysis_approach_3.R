...
#WRITE OUTPUT --------------------------------------------------------------------------
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Analysis/corr_matrix_approach_3.png",
            width = 1000,
            height = 1000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Analysis/corr_heatmap_approach_3.png",
            width = 1000,
            height = 1000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Analysis/residuals_plot_approach_3.png",
            width = 2000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Analysis/residuals_hist_approach_3.png",
            width = 2000,
            height = 1600,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Analysis/residuals_qq_approach_3.png",
            width = 1000,
            height = 1000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_3/Output/Analysis/actual_fitted_approach_3.png",
            width = 2000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        tab_model(model, digits = 5, file = "1_Albedo_Exclosures/Approach_3/Output/Analysis/model_approach_3.html")
