...
#EXPORT PLOTS --------------------------------------------------------------------------------------
        ...
        #WRITE CSV
        write.csv(data, "1_Albedo_Exclosures/Approach_1B/Output/tree_biomass/tree_biomass.csv")
        ...
        #Aggregate biomass (g) for each species by subplots within main plots
        ...
        #Aggregate and plot
                ...
                plot_theme <- theme(plot.title = element_text(hjust = 0.5, size = 50, margin = margin(t = 40, b = 40)),
                        ...
                        #Total Standing Biomass ------------
                                ...
                                #Faceted by site
                                png(filename = "1_Albedo_Exclosures/Approach_1A/Output/tree_biomass/biomass_diff_all_faceted.png",
                                    width = 1600,
                                    height = 1600,
                                    bg = "white")
                                ...
                                #All sites
                                png(filename = "1_Albedo_Exclosures/Approach_1A/Output/tree_biomass/biomass_diff_all.png",
                                    width = 1300,
                                    height = 1300,
                                    bg = "white")
                        ...
                        #Species-specific Biomass ------------
                                ...
                                #Plot ---------
                                        ...
                                        #Faceted by site
                                        png(filename = "1_Albedo_Exclosures/Approach_1A/Output/tree_biomass/biomass_diff_spec_faceted.png",
                                            width = 1600,
                                            height = 1600,
                                            bg = "white")
                                        ...
                                        #All sites
                                        png(filename = "1_Albedo_Exclosures/Approach_1A/Output/tree_biomass/biomass_spec_diff_all.png",
                                            width = 1800,
                                            height = 1300,
                                            bg = "white")
