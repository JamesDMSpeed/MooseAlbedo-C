...
#EXPORT PLOTS --------------------------------------------------------------------------------------
        ...
        #Pine
                ...
                png(filename = "1_Albedo_Exclosures/Approach_1A/Output/biomass_models/pine_backfit_model.png",
                    width = 1000,
                    height = 1000,
                    units = "px",
                    bg = "white")
        ...
        #Spruce
                ...
                png(filename = "1_Albedo_Exclosures/Approach_1A/Output/biomass_models/spruce_backfit_model.png",
                    width = 1000,
                    height = 1000,
                    units = "px",
                    bg = "white")
        ...
        #Birch
                ...
                png(filename = "1_Albedo_Exclosures/Approach_1A/Output/biomass_models/birch_backfit_model.png",
                    width = 1000,
                    height = 1000,
                    units = "px",
                    bg = "white")
        ...
        #Rowan
                ...
                png(filename = "1_Albedo_Exclosures/Approach_1A/Output/biomass_models/rowan_backfit_model.png",
                    width = 1000,
                    height = 1000,
                    units = "px",
                    bg = "white")
