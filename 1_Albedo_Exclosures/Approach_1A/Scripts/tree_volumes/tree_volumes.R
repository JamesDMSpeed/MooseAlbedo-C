...
#INITIAL DATA IMPORT ----------------------------------------------------------------------------------------------
        ...
        data <- read.csv('1_Albedo_Exclosures/Approach_1A/Output/tree_biomass/tree_biomass.csv', header = TRUE)
...
#CALCULATE VOLUME FOR EACH TREE ---------------------------------------------------
        ...
        #Filter out data from after 2018 (since we only have climate data until 2018 at the moment)
