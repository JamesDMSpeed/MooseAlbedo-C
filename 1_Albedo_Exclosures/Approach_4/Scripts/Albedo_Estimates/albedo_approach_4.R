...
##NOTE: The 'age' parameter for the albedo model is the 'Clearcut to LiDAR' value
        ...
        #Albedo function
                ...
                for(i in 1:length(site_data$LocalityCode)){
                        ...
                        #Get corresponding function arguments
                                ...
                                #Age
                                a_age <- site_data$ClearCutToLidar[site_data$LocalityCode == a]
...
#WRITE OUTPUT  ----------------------------------------------------------------------------
        ...
        write.csv(model_data, file = '1_Albedo_Exclosures/Approach_4/Output/Albedo_Estimates/albedo_estimates_approach_4.csv', row.names = TRUE)
        
        #Export albedo boxplot as PNG
        png(filename = "1_Albedo_Exclosures/Approach_4/Output/Albedo_Estimates/albedo_boxplot_approach_4.png",
            width = 2000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_4/Output/Albedo_Estimates/albedo_time_series_approach_4.png",
            width = 3000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_4/Output/Albedo_Estimates/albedo_grouped_boxplot_approach_4.png",
            width = 3000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_4/Output/Albedo_Estimates/albedo_histogram_approach_4.png",
            width = 2500,
            height = 2000,
            units = "px",
            bg = "white")
