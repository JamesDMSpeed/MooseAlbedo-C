...
**Summary:**
This document contains a summary of albedo estimates produced through 'Approach 1', including the figures listed below:
...
knitr::include_graphics("../../../Approach_1/Output/Albedo_Estimates/albedo_boxplot_approach_1.png")
knitr::include_graphics("../../../Approach_1/Output/Albedo_Estimates/albedo_histogram_approach_1.png")

```

```{r, echo=FALSE, out.width = '100%', fig.align="center"}

knitr::include_graphics("../../../Approach_1/Output/Albedo_Estimates/albedo_time_series_approach_1.png")
knitr::include_graphics("../../../Approach_1/Output/Albedo_Estimates/albedo_grouped_boxplot_approach_1.png")
...
knitr::include_graphics("../../../Approach_1/Output/Analysis/corr_matrix_approach_1.png")
knitr::include_graphics("../../../Approach_1/Output/Analysis/corr_heatmap_approach_1.png")
...
model <- lmer(Composite_Albedo ~ Treatment + Productivity_Index + Moose_Density + Red_Deer_Density + (1 | LocalityName/Month), data = model_data)

tab_model(model, digits = 5, file = "../../../Approach_1/Output/Analysis/model_approach_1.html")
...
knitr::include_graphics("../../../Approach_1/Output/Analysis/residuals_plot_approach_1.png")
knitr::include_graphics("../../../Approach_1/Output/Analysis/residuals_qq_approach_1.png")
knitr::include_graphics("../../../Approach_1/Output/Analysis/residuals_hist_approach_1.png")
knitr::include_graphics("../../../Approach_1/Output/Analysis/actual_fitted_approach_1.png")
...
albedo <- read.csv(file = '../../../Approach_1/Output/Albedo_Estimates/albedo_estimates_approach_1.csv', header = T)

#Load volumes
volumes <- read.csv(file = '../../../Approach_1/Output/Tree_Volumes/tree_volumes_approach_1.csv', header = T)
...
```{r fig.align="center", echo = FALSE, eval = TRUE, out.width="50%"}
                ...
                for(i in levels(sites$LocalityName)){
                        ...
                        #Get relevant subsets of data
                                ...
                                #Volume
                                vol <- volumes[volumes$LocalityName == site,]
                        ...
                        plot1 <- ggplot(data = vol, aes(x = Treatment, y = Volume_m3, fill = Treatment)) +
