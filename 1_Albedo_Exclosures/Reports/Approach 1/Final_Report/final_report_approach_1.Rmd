...
At certain points throughout the report, you may see a "question box" (example below). I've put important questions that I think should be discussed in these boxes, in an attempt to make them clear and easily referenceable.

> Question Box: This is a sample question.
...
> Is there a better approach to identify a 'best' model?
