...
# Overview
This report contains a summary of 'Approach 3', which uses existing SustHerb LiDAR data from [Snøan (2019)](https://ntnuopen.ntnu.no/ntnu-xmlui/handle/11250/2618099?locale-attribute=no) and a 'volume under CHM' method to estimate volume (and ultimately, albedo) for relevant study plots. The report covers each step of the analysis and discusses potential limitations/assumptions associated with each step.

![](https://allyworks.io/moose-albedo/img/Approach_3_Flowchart.png)
...
![](https://allyworks.io/moose-albedo/img/plot_volumes_approach_3.png)


##### Density Plot
![](https://allyworks.io/moose-albedo/img/plot_volumes_density_approach_3.png)


##### By Study Site
![](https://allyworks.io/moose-albedo/img/plot_volumes_faceted_approach_3.png)
...
![](https://allyworks.io/moose-albedo/img/drangedal4_ub_1.png)

![](https://allyworks.io/moose-albedo/img/drangedal4_ub_2.png)

**Furesdal (Exclosure):**

![](https://allyworks.io/moose-albedo/img/furesdal_ub_1.png)

![](https://allyworks.io/moose-albedo/img/furesdal_ub_2.png)
...
``` {r echo = FALSE, eval= TRUE, message = FALSE}
        ...
        model_data <- read.csv("../../../Approach_3/Output/Albedo_Estimates/albedo_estimates_approach_3.csv")
