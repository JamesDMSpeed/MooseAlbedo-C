...
albedo <- read.csv(file = '../../../Approach_3/Output/Albedo_Estimates/albedo_estimates_approach_3.csv', header = T)

#Load volumes
volumes <- read.csv(file = '../../../Approach_3/Output/Tree_Volumes/total_plot_volumes_approach_3.csv', header = T)
...
```{r fig.align="center", echo = FALSE, eval = TRUE, out.width="50%"}
                ...
                for(i in levels(sites$LocalityName)){
                        ...
                        plot1 <- ggplot(data = vol, aes(x = Treatment, y = Total_plot_volume, fill = Treatment)) +
