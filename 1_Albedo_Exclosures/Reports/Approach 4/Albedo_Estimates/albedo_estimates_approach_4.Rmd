...
# Albedo Estimates - Approach 4
## ("Stand Age" Approach)

**Summary:**
This document contains a summary of albedo estimates produced through 'Approach 4' (using an age-based variant of the albedo model), including the figures listed below:
...
## Section 1
This figure shows several plots related to the final albedo estimates produced by Approach 4. 
  
```{r pressure, echo=FALSE, out.width = '80%', fig.align="center"}

knitr::include_graphics("../../../Approach_4/Output/Albedo_Estimates/albedo_boxplot_approach_4.png")
knitr::include_graphics("../../../Approach_4/Output/Albedo_Estimates/albedo_histogram_approach_4.png")

```

```{r, echo=FALSE, out.width = '100%', fig.align="center"}

knitr::include_graphics("../../../Approach_4/Output/Albedo_Estimates/albedo_time_series_approach_4.png")
knitr::include_graphics("../../../Approach_4/Output/Albedo_Estimates/albedo_grouped_boxplot_approach_4.png")
...
knitr::include_graphics("../../../Approach_4/Output/Analysis/corr_matrix_approach_4.png")
knitr::include_graphics("../../../Approach_4/Output/Analysis/corr_heatmap_approach_4.png")
...
**Model in R**: 
Random effect is month nested under site ("LocalityName"). Clearcut_Lidar (i.e. "age" of plot) is added as a fixed effect.
...
tab_model(model, digits = 5, file = "../../../Approach_4/Output/Analysis/model_approach_4.html")
...
knitr::include_graphics("../../../Approach_4/Output/Analysis/residuals_plot_approach_4.png")
knitr::include_graphics("../../../Approach_4/Output/Analysis/residuals_qq_approach_4.png")
knitr::include_graphics("../../../Approach_4/Output/Analysis/residuals_hist_approach_4.png")
knitr::include_graphics("../../../Approach_4/Output/Analysis/actual_fitted_approach_4.png")
...
albedo <- read.csv(file = '../../../Approach_4/Output/Albedo_Estimates/albedo_estimates_approach_4.csv', header = T)
...
```{r fig.align="center", echo = FALSE, eval = TRUE, out.width="50%"}
                ...
                for(i in levels(sites$LocalityName)){
                        ...
                        #Get relevant subsets of data
                                ...
                                #Age
                                age <- as.numeric(albedo$Clearcut_Lidar[albedo$LocalityName == i][[1]])
