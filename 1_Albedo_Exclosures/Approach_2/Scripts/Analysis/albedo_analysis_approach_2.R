## This script contains code for the analysis of albedo estimates produced by Approach 2
...
#WRITE OUTPUT --------------------------------------------------------------------------
        ...
        png(filename = "1_Albedo_Exclosures/Approach_2/Output/Analysis/corr_matrix_approach_2.png",
            width = 1000,
            height = 1000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_2/Output/Analysis/corr_heatmap_approach_2.png",
            width = 1000,
            height = 1000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_2/Output/Analysis/residuals_plot_approach_2.png",
            width = 2000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_2/Output/Analysis/residuals_hist_approach_2.png",
            width = 2000,
            height = 1600,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_2/Output/Analysis/residuals_qq_approach_2.png",
            width = 1000,
            height = 1000,
            units = "px",
            bg = "white")
        ...
        png(filename = "1_Albedo_Exclosures/Approach_2/Output/Analysis/actual_fitted_approach_2.png",
            width = 2000,
            height = 2000,
            units = "px",
            bg = "white")
        ...
        tab_model(model, digits = 5, file = "1_Albedo_Exclosures/Approach_2/Output/Analysis/model_approach_2.html")
