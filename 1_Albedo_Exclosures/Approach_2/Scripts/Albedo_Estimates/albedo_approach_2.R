...
#INITIAL DATA IMPORT + FORMATTING ----------------------------------------------------------------------
        ...
        ## VOLUMES
                ...
                plot_volumes <- read.csv('1_Albedo_Exclosures/Approach_2/Output/Tree_Volumes/total_plot_volumes_approach_2.csv', header = TRUE)
        
                #Add plot volumes to existing site data (i.e. create 'main' dataset)
                main <- cbind(site_data, plot_volumes$Summed_crown_volume)
...
#CALCULATE MONTHLY ALBEDOS -----------------------------------------------------------------------------
        ...
        #Albedo function
                ...
                for(i in 1:length(site_data$LocalityCode)){
                        ...
                        #Volume
                        a_vol <- plot_volumes$Summed_crown_volume[plot_volumes$Site_name == b & plot_volumes$Treatment == c]
...
#WRITE OUTPUT  ----------------------------------------------------------------------------
        ...
        write.csv(model_data, file = '1_Albedo_Exclosures/Approach_2/Output/Albedo_Estimates/albedo_estimates_approach_2.csv', row.names = TRUE)
