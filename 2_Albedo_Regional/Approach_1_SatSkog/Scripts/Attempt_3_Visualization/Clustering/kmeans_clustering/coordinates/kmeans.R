...
#KMEANS CLUSTERING (WITH COORDINATES) ---------------------------------------------------------------------------------------
        ...
        #K-Means Clustering ---------
                ...
                write.csv(norm1, "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/kmeans_normalized_has_coords.csv")
                ...
                ## Source: https://towardsdatascience.com/clustering-analysis-in-r-using-k-means-73eca4fb7967
                        ...
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/wss_scree_plot.png",
                            width = 2000,
                            height = 2000,
                            units = "px",
                            bg = "white")
...
#SUMMARY of wssplot: Elbow plot seems to indicate that ~11 clusters is ideal for kmeans clustering ------
        ...
        #Save shapefile ----------
                ...
                st_write(data_viz, "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/shapefile/kmeans_clustered.shp", driver = "ESRI Shapefile", append = FALSE)
                
        
                #Plot clusters together -------
                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/kmeans_clusters.png",
                    width = 1200,
                    height = 1200,
                    units = "px",
                    bg = "white")
                ...
                for(i in 1:11){
                        ...
                        png(filename = paste("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/geometry/cluster_", i, ".png", sep = ""),
                            bg = "white",
                            height = 1500,
                            width = 1500,
                            units = "px")
                ...
                for(i in 1:11){
                        ...
                        png(filename = paste("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/descriptive/descriptive_plot_", i, ".png", sep = ""),
                            bg = "white",
                            height = 1500,
                            width = 1500,
                            units = "px")
...
##SUBSET TO CLUSTERS 2,7-11 (good spread of moose density)
                
        #Subset data to clusters 1-4
        sel <- data_viz[data_viz$Cluster %in% c(2,7:11),]    
        ...
        #NO AGE INTERVAL ------
                ...
                #January
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/scatterplots/density_albedo_jan.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/scatterplots/density_albedo_birch_jan.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                ...
                #April
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/scatterplots/density_albedo_april.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/scatterplots/density_albedo_birch_april.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
        ...
        #AGE INTERVAL (15x 2-year intervals) --------
                ...
                #January
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/scatterplots/density_albedo_jan_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/scatterplots/density_albedo_birch_jan_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                ...
                #April
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/scatterplots/density_albedo_april_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_3_Visualization/Clustering/kmeans_clustering/coordinates/clusters/scatterplots/density_albedo_birch_april_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
