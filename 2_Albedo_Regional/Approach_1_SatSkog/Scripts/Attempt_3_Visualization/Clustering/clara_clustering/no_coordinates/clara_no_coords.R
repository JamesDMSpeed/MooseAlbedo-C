...
#CLARA CLUSTERING ------------------------------------------------------------------------------
        ...
        write.csv(norm1, "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clara_normalized_variables.csv")
        ...
        #Run the CLARA algorithm ----------
                ...
                #Method: Average Silhouette Method (Kaufman and Rousseeuw 1990)
                        ...
                        #DB is lowest (Long et al. (2010)) - i.e. where DB - ASW is lowest
                                ...
                                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clara_clustering_indices_plot.png",
                                    bg = "white",
                                    height = 900,
                                    width = 1200,
                                    units = "px")
...
## DB is smallest and ASW is largest when K = 13 clusters --------------
## Let's explore CLARA clustering with k = 13
                                
        
        #CLARA algorithm w/ k = 13
        set.seed(123)
        clara.res <- clara(norm1, k = 13, metric = "euclidean", stand = T, 
                           samples = 50, pamLike = FALSE, correct.d = T)
        beep(b)
        ...
        #Save shapefile ----------
                ...
                st_write(data_viz, "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/shapefile/clara_clustered.shp", driver = "ESRI Shapefile", append = FALSE)
                
                #LOAD SHAPEFILE (IF COMING BACK TO CODE)
                data_viz <- st_read("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/shapefile/clara_clustered.shp")
                
        #Visualize clusters in a plot -----------
                
                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clara_clustering.png",
                    bg = "white",
                    height = 1500,
                    width = 1500,
                    units = "px")
                ...
                beep(b)
                        ...
                        for(i in 1:13){
                                ...
                                png(filename = paste("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/geometry/cluster_", i, ".png", sep = ""),
                                    bg = "white",
                                    height = 1500,
                                    width = 1500,
                                    units = "px")
        ...
        #Visualize silhouette plot of CLARA w/ k=6 -------------
                
                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clara_silhouette_plot.png",
                    bg = "white",
                    height = 1500,
                    width = 1500,
                    units = "px")
        ...
        #Examine each cluster in greater detail ----------
                ...
                for(i in 1:10){
                        ...
                        png(filename = paste("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/descriptive/descriptive_plot_", i, ".png", sep = ""),
                            bg = "white",
                            height = 1500,
                            width = 1500,
                            units = "px")
...
##NOTE: Subsetting to Clusters 1-6 - good spread of moose density (unlike other clusters)
                        
        #Subset data to clusters 1-4
        sel <- data_viz[data_viz$Cluster %in% c(1:6),]
        ...
        #NO AGE INTERVAL ------
                ...
                #January
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/scatterplots/density_albedo_jan.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/scatterplots/density_albedo_birch_jan.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                ...
                #April
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/scatterplots/density_albedo_april.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/scatterplots/density_albedo_birch_april.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
        ...
        #AGE INTERVAL (15x 2-year intervals) --------
                ...
                #January
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/scatterplots/density_albedo_jan_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/scatterplots/density_albedo_birch_jan_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                ...
                #April
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/scatterplots/density_albedo_april_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/no_coordinates/clusters/scatterplots/density_albedo_birch_april_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
...
#NOT SEEING TRENDS WITHIN CLUSTERS - FURTHER INVESTIGATION BELOW ---------------------
                
        #How does forest volume vary with moose density?
        ggplot(data = sel, aes(x = Ms_Dnst, y = vuprha, color = Cluster, group = Cluster)) +
                geom_point(alpha = 0.1, size = 0.4) +
                geom_jitter(alpha = 0.1, size = 0.4) +
                geom_smooth() +
                facet_wrap(~ Cluster) +
                ggtitle("Plot Volume vs. Moose Density\n(Faceted by Cluster)") +
                labs(x = "Moose Metabolic Biomass (kg/km2)", y = "Plot Volume (m3/ha)")
                
                        #Not seeing much of a trend
