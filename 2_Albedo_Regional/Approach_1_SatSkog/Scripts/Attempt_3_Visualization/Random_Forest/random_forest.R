...
#RANDOM FOREST MODEL CREATION ---------------------------------------------------------------------------------------
        ...
        #Get UTM33N centroid coordinates to dataset (centroids from largest polygon of each observation)
        ...
        #Subset to data used to train model
                
                #Age
                #Elevation
                #Dominant tree type
                
                        #Excluding SWE and Temp, since these were used
        
        
#END RANDOM FOREST MODEL CREATION ---------------------------------------------------------------------------------------
...
#END RF VARIABLE IMPORTANCE ---------------------------------------------------------------------------------------
        ...
        #K-Means Clustering ---------
                ...
                #Standardize the data (using caret package) & remove NA rows ----------
                ...
                write.csv(norm1, "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/kmeans_normalized_has_coords.csv")
                ...
                ## Source: https://towardsdatascience.com/clustering-analysis-in-r-using-k-means-73eca4fb7967
                        ...
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/wss_scree_plot.png",
                            width = 2000,
                            height = 2000,
                            units = "px",
                            bg = "white")
...
#SUMMARY of wssplot: Elbow plot seems to indicate that 14 clusters is ideal for kmeans clustering ------
        
        
        #K-means clustering with 4 clusters (k = 14) --------------
        set.seed(1234)
        dc_k <- kmeans(norm1, centers = 14, nstart = 20) 
        ...
        #Save shapefile ----------
                ...
                st_write(data_viz, "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/shapefile/kmeans_clustered.shp", driver = "ESRI Shapefile", append = FALSE)
                
        
                #Plot clusters together -------
                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/kmeans_clusters.png",
                    width = 1200,
                    height = 1200,
                    units = "px",
                    bg = "white")
                ...
                for(i in 1:14){
                        ...
                        png(filename = paste("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/geometry/cluster_", i, ".png", sep = ""),
                            bg = "white",
                            height = 1500,
                            width = 1500,
                            units = "px")
                ...
                for(i in 1:10){
                        ...
                        png(filename = paste("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/descriptive/descriptive_plot_", i, ".png", sep = ""),
                            bg = "white",
                            height = 1500,
                            width = 1500,
                            units = "px")
...
##NOTE: Subsetting to clusters 2,3,4,6,7,9,11,12 - they have a range of moose densities, while other clusters don't
                
        #Subset data to clusters 1-4
        sel <- data_viz[data_viz$Cluster %in% c(2,3,4,6,7,9,11,12),]
        ...
        #NO AGE INTERVAL ------
                ...
                #January
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/scatterplots/density_albedo_jan.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/scatterplots/density_albedo_birch_jan.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                ...
                #April
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/scatterplots/density_albedo_april.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/scatterplots/density_albedo_birch_april.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
        ...
        #AGE INTERVAL (15x 2-year intervals) --------
                ...
                #January
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/scatterplots/density_albedo_jan_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/scatterplots/density_albedo_birch_jan_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                ...
                #April
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/scatterplots/density_albedo_april_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/kmeans_clustering/no_coordinates/clusters/scatterplots/density_albedo_birch_april_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
