...
#IMPORT DATA --------------------------------------------------------------------------------------------------
        ...
        data <- st_read("2_Albedo_Regional/Approach_1_SatSkog/Output/Final_Approach/corrected_shapefile/corrected_shapefile.shp")
...
#CLARA CLUSTERING ------------------------------------------------------------------------------
        ...
        #Subset dataset to desired variables for clustering ----------
                ...
                #VARIABLES:
                        ...
                        cl <- st_drop_geometry(data[,c(1,14,42:65)])
        ...
        #Run the CLARA algorithm ----------
                ...
                #Method: Average Silhouette Method (Kaufman and Rousseeuw 1990)
                        ...
                        #DB is lowest (Long et al. (2010)) - i.e. where DB - ASW is lowest
                                ...
                                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Final_Approach/clara_clustering/clara_clustering_indices_plot.png",
                                    bg = "white",
                                    height = 600,
                                    width = 900,
                                    units = "px")
...
## DB is smallest and ASW is largest when K = 5 clusters, BUT more clusters = better. Let's go w/ k = 11 --------------
## Let's explore CLARA clustering with k = 11
        ...
        #Bind cluster IDs to spatial object ----------
                ...
                data_viz <- cbind(data, clara.res$clustering)
        ...
        #Visualize clusters in a plot -----------
                ...
                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Final_Approach/clara_clustering/clara_clustering.png",
                    bg = "white",
                    height = 1500,
                    width = 1500,
                    units = "px")
        ...
        #Visualize silhouette plot of CLARA w/ k=11 -------------
                ...
                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Final_Approach/clara_clustering/clara_silhouette_plot.png",
                    bg = "white",
                    height = 1000,
                    width = 1000,
                    units = "px")
