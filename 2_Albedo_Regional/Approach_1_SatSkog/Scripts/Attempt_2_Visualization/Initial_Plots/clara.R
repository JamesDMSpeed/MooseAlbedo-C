...
#CLARA CLUSTERING ------------------------------------------------------------------------------
        ...
        write.csv(norm1, "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clara_normalized_variables.csv")
        ...
        #Run the CLARA algorithm ----------
                ...
                #Method: Average Silhouette Method (Kaufman and Rousseeuw 1990)
                        ...
                        #DB is lowest (Long et al. (2010)) - i.e. where DB - ASW is lowest
                                ...
                                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clara_clustering_indices_plot.png",
                                    bg = "white",
                                    height = 900,
                                    width = 1200,
                                    units = "px")
...
## Let's explore CLARA clustering with k = 11
        ...
        #Save shapefile ----------
                ...
                st_write(data_viz, "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/shapefile/clara_clustered.shp", driver = "ESRI Shapefile", append = FALSE)
                
                
        #Visualize clusters in a plot -----------
                
                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clara_clustering.png",
                    bg = "white",
                    height = 1500,
                    width = 1500,
                    units = "px")
                ...
                beep(b)
                        ...
                        for(i in 1:11){
                                ...
                                png(filename = paste("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/geometry/cluster_", i, ".png", sep = ""),
                                    bg = "white",
                                    height = 1500,
                                    width = 1500,
                                    units = "px")
        ...
        #Visualize silhouette plot of CLARA w/ k=6 -------------
                ...
                png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clara_silhouette_plot.png",
                    bg = "white",
                    height = 1500,
                    width = 1500,
                    units = "px")
        ...
        #Examine each cluster in greater detail ----------
                ...
                for(i in 1:10){
                        ...
                        png(filename = paste("2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/descriptive/descriptive_plot_", i, ".png", sep = ""),
                            bg = "white",
                            height = 1500,
                            width = 1500,
                            units = "px")
...
##NOTE: Subsetting to Clusters 1, 2, 3, 6, and 7 - good spread of moose density (unlike other clusters)
        ...
        #NO AGE INTERVAL ------
                ...
                #January
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/scatterplots/density_albedo_jan.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/scatterplots/density_albedo_birch_jan.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                ...
                #April
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/scatterplots/density_albedo_april.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/scatterplots/density_albedo_birch_april.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
        ...
        #AGE INTERVAL (15x 2-year intervals) --------
                ...
                #January
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/scatterplots/density_albedo_jan_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/scatterplots/density_albedo_birch_jan_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                ...
                #April
                        ...
                        #Spruce
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/scatterplots/density_albedo_april_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
                        ...
                        #Birch
                        png(filename = "2_Albedo_Regional/Approach_1_SatSkog/Output/Attempt_2_Visualization/Initial_Plots/clara_clustering/coordinates/clusters/scatterplots/density_albedo_birch_april_by_age.png",
                            bg = "white",
                            height = 1000,
                            width = 1000,
                            units = "px")
