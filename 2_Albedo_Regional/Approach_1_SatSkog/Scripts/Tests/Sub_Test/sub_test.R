...
#SHAPEFILE PROCESSING --------------------------------------------------------------------------------------------------
        ...
        #PROCESS DATA ------------------  
                ...
                dirs <- list.dirs(path="2_Albedo_Regional/Data/Spatial_Data/Test/Directories", full.names=TRUE, recursive=FALSE)
                ...
                for(dir in dirs){
                        ...
                        #CHECK IF DIRECTORY ALREADY EXISTS - if so, skip ------------
                                ...
                                #Construct directory path
                                        ...
                                        #Define output path
                                        output_path <- paste("2_Albedo_Regional/Data/Spatial_Data/Test/Output/",
                                                             dir_base,
                                                             '/',
                                                             sep = '')
