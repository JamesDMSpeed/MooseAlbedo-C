...
#It only uses the 'Oslo' file of SatSkog data, and is meant to develop a workflow which will allow for processing
...
#INITIAL DATA IMPORT ----------------------------------------------------------------------------------------------
        ...
        #SatSkog Spatial Data Product
                ...
                satskog <- st_read("2_Albedo_Regional/Data/Spatial_Data/SatSkog/Oslo/0301_25833_satskog_5e625e_SHAPE.shp")
...
#INITIAL DATA EXPLORATION + FILTERING --------------------------------------------------------------------------------------------
        ...
        #SATSKOG DATA PRODUCT -------------
                ...
                #Filter and clean up data
                        ...
                        #satskog <- satskog[satskog$kvalitet != "redusert",] #All of these are NAs for Oslo data
                        
                        #Make sure all pictures from same year (1999), to be as close to 1999 herbivore density data as possible
                        #satskog <- satskog[satskog$bildedato == '060899',] #All of these are from 2007
                        
                        #Filter to 'Clear Sky' observations ('ikke_sky') 
                        #satskog <- satskog[satskog$class_sky == 'ikke_sky',] #All of these are some strange code
...
#EXTRACT SENORGE DATA & CALCULATE ALBEDO FOR EACH POLYGON -------------------------------------------------------------------------
        ...
        write.csv(satskog, file = '2_Albedo_Regional/Approach_1_SatSkog/Output/Oslo_Test/oslo_test.csv', row.names = TRUE)
