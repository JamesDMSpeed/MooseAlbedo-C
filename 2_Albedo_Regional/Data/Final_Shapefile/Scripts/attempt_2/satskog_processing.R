                                        ...
                                        system.time({
                                                ...
                                                if( nrow(satskog_sub) > 0 ){
                                                        ...
                                                        #Create placeholder columns in main SatSkog df
                                                                ...
                                                                #Volume (m3/ha*ha)
                                                                satskog_sub$Total_Stand_Volume_m3 <- ''
                                                        
                                                                #Spruce
                                                                satskog_sub$Month_1_Albedo_Spruce <- ''
                                                                satskog_sub$Month_2_Albedo_Spruce <- ''
                                                                satskog_sub$Month_3_Albedo_Spruce <- ''
                                                                satskog_sub$Month_4_Albedo_Spruce <- ''
                                                                satskog_sub$Month_5_Albedo_Spruce <- ''
                                                                satskog_sub$Month_6_Albedo_Spruce <- ''
                                                                satskog_sub$Month_7_Albedo_Spruce <- ''
                                                                satskog_sub$Month_8_Albedo_Spruce <- ''
                                                                satskog_sub$Month_9_Albedo_Spruce <- ''
                                                                satskog_sub$Month_10_Albedo_Spruce <- ''
                                                                satskog_sub$Month_11_Albedo_Spruce <- ''
                                                                satskog_sub$Month_12_Albedo_Spruce <- ''
                                                                
                                                                #Pine
                                                                satskog_sub$Month_1_Albedo_Pine <- ''
                                                                satskog_sub$Month_2_Albedo_Pine <- ''
                                                                satskog_sub$Month_3_Albedo_Pine <- ''
                                                                satskog_sub$Month_4_Albedo_Pine <- ''
                                                                satskog_sub$Month_5_Albedo_Pine <- ''
                                                                satskog_sub$Month_6_Albedo_Pine <- ''
                                                                satskog_sub$Month_7_Albedo_Pine <- ''
                                                                satskog_sub$Month_8_Albedo_Pine <- ''
                                                                satskog_sub$Month_9_Albedo_Pine <- ''
                                                                satskog_sub$Month_10_Albedo_Pine <- ''
                                                                satskog_sub$Month_11_Albedo_Pine <- ''
                                                                satskog_sub$Month_12_Albedo_Pine <- ''
                                                                
                                                                #Birch
                                                                satskog_sub$Month_1_Albedo_Birch <- ''
                                                                satskog_sub$Month_2_Albedo_Birch <- ''
                                                                satskog_sub$Month_3_Albedo_Birch <- ''
                                                                satskog_sub$Month_4_Albedo_Birch <- ''
                                                                satskog_sub$Month_5_Albedo_Birch <- ''
                                                                satskog_sub$Month_6_Albedo_Birch <- ''
                                                                satskog_sub$Month_7_Albedo_Birch <- ''
                                                                satskog_sub$Month_8_Albedo_Birch <- ''
                                                                satskog_sub$Month_9_Albedo_Birch <- ''
                                                                satskog_sub$Month_10_Albedo_Birch <- ''
                                                                satskog_sub$Month_11_Albedo_Birch <- ''
                                                                satskog_sub$Month_12_Albedo_Birch <- ''
                                                        ...
                                                        #Calculate albedo for each polygon ------
                                                                ...
                                                                #Total volume ----
                                                                        ...
                                                                        satskog_sub$areal_hekt <- as.numeric(gsub(',', '.', satskog_sub$areal_hekt))
                                                                
                                                                        #Multiply m3/ha value * total area
                                                                        satskog_sub$Total_Stand_Volume_m3 <- satskog_sub$vuprha * satskog_sub$areal_hekt
                                                                ...
                                                                ## NOTE: Doing this in a vectorized manner - GREATLY REDUCES TIME
                                                                        ...
                                                                        for(j in 1:12){
                                                                                ...
                                                                                #Spruce albedo
                                                                                satskog_sub[, paste("Month_", j, "_Albedo_Spruce", sep = "")] <- 0.077+0.072*(1-1/(1+exp(-2.354*((satskog_sub[, paste("Temp_Month_", j, sep = "")][[1]])-273.433))))+0.074*(1/(1+exp(-0.191*((satskog_sub[, paste("SWE_Month_", j, sep = "")][[1]])-33.093))))+0.252*exp(-0.023*(satskog_sub$Total_Stand_Volume_m3))*(1-0.7*exp(-0.011*(satskog_sub[, paste("SWE_Month_", j, sep = "")][[1]])))
                                                                                
                                                                                #Pine albedo
                                                                                satskog_sub[, paste("Month_", j, "_Albedo_Pine", sep = "")] <- 0.069+0.084*(1-1/(1+exp(-1.965*((satskog_sub[, paste("Temp_Month_", j, sep = "")][[1]])-273.519))))+0.106*(1/(1+exp(-0.134*((satskog_sub[, paste("SWE_Month_", j, sep = "")][[1]])-30.125))))+0.251*exp(-0.016*(satskog_sub$Total_Stand_Volume_m3))*(1-0.7*exp(-0.008*(satskog_sub[, paste("SWE_Month_", j, sep = "")][[1]])))
                                                                                
                                                                                #Birch albedo
                                                                                satskog_sub[, paste("Month_", j, "_Albedo_Birch", sep = "")] <- 0.085+0.089*(1-1/(1+exp(-2.414*((satskog_sub[, paste("Temp_Month_", j, sep = "")][[1]])-273.393))))+0.169*(1/(1+exp(-0.107*((satskog_sub[, paste("SWE_Month_", j, sep = "")][[1]])-37.672))))+0.245*exp(-0.023*(satskog_sub$Total_Stand_Volume_m3))*(1-0.7*exp(-0.004*(satskog_sub[, paste("SWE_Month_", j, sep = "")][[1]])))
...
#SHAPEFILE UNIFICATION -------------------------------------------------------------------------
        ...
        ##ADDITIONAL FILTERING STEPS
                ...
                colnames(final_shp)[42] <- "SWE_M_1"
                colnames(final_shp)[61] <- "Tmp_M_10"
                colnames(final_shp)[63] <- "Tmp_M_11"
                colnames(final_shp)[65] <- "Tmp_M_12"
        ...
        ##1999-ONLY VERSION OF SHAPEFILE
        final_1999 <- final_shp[final_shp$Snrg_yr == "1999",]
...
#WRITE OUTPUT ----------------------------------------------------------------------------
        ...
        st_write(final_shp, "2_Albedo_Regional/Data/Final_Shapefile/Output/attempt_2/full_resolution/final_shapefile_v2.shp", driver = "ESRI Shapefile", append = FALSE)

        #Write 1999-only ESRI shapefile to relevant output directory
        st_write(final_shp, "2_Albedo_Regional/Data/Final_Shapefile/Output/attempt_2/full_res_1999/final_shapefile_v2_1999_only.shp", driver = "ESRI Shapefile", append = FALSE)
